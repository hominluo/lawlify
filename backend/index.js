...
const OPENAI_API_KEY = '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';
...
const processFiles = async (query) => {
  const rawDataDir = path.join(process.cwd(), 'data', 'parsed');
...
const main = async () => {
  ...
  app.listen(port, () => {
    console.log(`Lawlify backend listening on port ${port}`);
  });
};
